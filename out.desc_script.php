...
/**
 *      \file       descuentos/desc_script.php
 *		\ingroup    descuentos
...
// Examples for manipulating class desc_class
require_once(DOL_DOCUMENT_ROOT."/../descuentos/desc.class.php");
$myobject=new Desc($db);
