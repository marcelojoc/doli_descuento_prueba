...
/**
 *  Description and activation class for module descuentos
 */
class modDescuentos extends DolibarrModules
{
	/**
	...
	public function __construct($db)
	{
		...
		// for default path (eg: /descuentos/core/xxxxx) (0=disable, 1=enable)
		// for specific path of parts (eg: /descuentos/core/modules/barcode)
		// for specific css file (eg: /descuentos/css/descuentos.css.php)
		...
		//							'css' => array('/descuentos/css/descuentos.css.php'),	// Set this to relative path of css file if module has its own css file
	 	//							'js' => array('/descuentos/js/descuentos.js'),          // Set this to relative path of js file if module must load a js on all pages
		...
		//                        );
		$this->module_parts = array('css' => array('/descuentos/css/descuentos.css.php'));

		// Data directories to create when module is enabled.
		// Example: this->dirs = array("/descuentos/temp");
		$this->dirs = array();

		// Config pages. Put here list of php page, stored into descuentos/admin directory, to use to setup module.
		$this->config_page_url = array("adminDescuentos.php@descuentos");
		...
		$this->langfiles = array("mylangfile@descuentos");

		// Constants
		// List of particular constants to add when module is enabled (key, 'chaine', value, desc, visible, 'current' or 'allentities', deleteonunactive)
		// Example: $this->const=array(0=>array('descuentos_MYNEWCONST1','chaine','myvalue','This is a constant to add',1),
		//                             1=>array('descuentos_MYNEWCONST2','chaine','myvalue','This is another constant to add',0, 'current', 1)
		// );
		$this->const = array();

		// Array to add new pages in new tabs
		 Example: $this->tabs = array('product:+tabname1:Title1:mylangfile@descuentos:$user->rights->descuentos->read:/descuentos/mynewtab1.php?id=__ID__',  					// To add a new tab identified by code tabname1
                                      'objecttype:+tabname2:SUBSTITUTION_Title2:mylangfile@descuentos:$user->rights->othermodule->read:/descuentos/mynewtab2.php?id=__ID__',  	// To add another new tab identified by code tabname2. Label will be result of calling all substitution functions on 'Title2' key.
        ...
        // Dictionaries
	    if (! isset($conf->descuentos->enabled))
        {
        	$conf->descuentos=new stdClass();
        	$conf->descuentos->enabled=0;
        }
		$this->dictionaries=array();
        /* Example:
        if (! isset($conf->descuentos->enabled)) $conf->descuentos->enabled=0;	// This is to avoid warnings
        $this->dictionaries=array(
            'langs'=>'mylangfile@descuentos',
            ...
            'tabcond'=>array($conf->descuentos->enabled,$conf->descuentos->enabled,$conf->descuentos->enabled)												// Condition to show each dictionary
        );
        */
		...
		// Example:
		//$this->boxes=array(
		//    0=>array('file'=>'myboxa.php@descuentos','note'=>'','enabledbydefaulton'=>'Home'),
		//    1=>array('file'=>'myboxb.php@descuentos','note'=>''),
		//    2=>array('file'=>'myboxc.php@descuentos','note'=>'')
		//);
		...
		// Example to declare a new Top Menu entry and its Left menu entry:
		 $this->menu[$r]=array(	'fk_menu'=>'',			                // '' if this is a top menu. For left menu, use 'fk_mainmenu=xxx' or 'fk_mainmenu=xxx,fk_leftmenu=yyy' where xxx is mainmenucode and yyy is a leftmenucode
								...
								'mainmenu'=>'descuentos',
									...
									'perms'=>'1',			                // Use 'perms'=>'$user->rights->descuentos->level1->level2' if you want your menu with a permission rules
									'target'=>'',
		...
		// $this->export_label[$r]='descuentos';	// Translation key (used only if key ExportDataset_xxx_z not found)
        // $this->export_enabled[$r]='1';                               // Condition to show export in list (ie: '$user->id==3'). Set to 1 to always show when module is enabled.
        // $this->export_icon[$r]='generic:descuentos';
		// $this->export_permission[$r]=array(array("descuentos","level1","level2"));
	...
	public function init($options='')
	{
		...
		$this->_load_tables('/descuentos/sql/');
