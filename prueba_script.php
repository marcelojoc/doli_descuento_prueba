...
/**
 *      \file       Descuentos/prueba_script.php
 *		\ingroup    Descuentos
...
// Examples for manipulating class prueba_class
require_once(DOL_DOCUMENT_ROOT."/../Descuentos/prueba.class.php");
$myobject=new Prueba($db);
